...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal well">
		...
		<div class="control-group">
			<div class="controls">
				<button class="btn btn-primary validate mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
